...
namespace TwitchDownloaderCLI
{
    ...
    class Options
    {
        ...
        [Option("composer-args", Default = "{input_files} -map 0:a -c:a copy -c:v libx264 -preset veryfast -crf 18 -pix_fmt yuv420p -filter_complex \"{input_mappings} {filtergraph}\" -map \"[output]\" -y \"{save_path}\"", HelpText = "Arguments for ffmpeg batch composition.")]
